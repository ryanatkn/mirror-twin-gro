<script lang="ts">
	...
	import type {Image_Info} from './images_store.js';
	import type {Image_Handle_Movement, Image_Handles_State} from './image_handles_store.js';
	import type {Mirror_Twins_Layout} from './mirror_twins_layout_store.js';
	import type {Source_Image_Layout} from './source_image_layout_store.js';
	import type {Source_Image_Selection} from './source_image_selection_store.js';
	import type {Mirror_Images_Layout} from './mirror_images_layout_store.js';
