<script lang="ts">
	...
	import type {Image_HandleMovement, Image_HandlesState} from './image_handles_store.js';
	import type {Mirror_TwinsLayout} from './mirror_twins_layout_store.js';
	import type {Source_ImageLayout} from './source_image_layout_store.js';
	import type {Source_ImageSelection} from './source_image_selection_store.js';
	import type {Mirror_ImagesLayout} from './mirror_images_layout_store.js';
